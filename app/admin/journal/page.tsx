...
type Submission = {
  ...
  publishedAt?: Timestamp | Date | string | number;
...
export default function PublishedPapersPage() {
  ...
  const loadApprovedPapers =
    async () => {
      try {
        ...
        setError(
          "Unable to load approved papers. Please check your Firestore permissions."
        );
      } finally {
        setLoading(false);
        setRefreshing(false);
  ...
  const handleSelectPaper = (
    ...
    /*
     * Reset form when changing paper
     */
  ...
  const handlePublish =
    async () => {
      ...
      try {
        ...
        /*
         * ======================================================
         * 3. Create published paper
         * ======================================================
         *
         * Store the complete submission under
         * the published paper.
         */
         ...
         *
         * Publication status is stored separately.
         */
        ...
        console.error(
          "PUBLISHED PAPERS: Publish error:",
          err
        );
        ...
        setPublishError(
          "Failed to publish the paper. Please try again."
        );
      }
    };
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6">
            ...
            <div>
              ...
              <p className="!text-[#666666] text-sm mt-1.5">
                Select an approved paper and assign its journal year and volume.
              </p>
                ...
                <div className="py-16 px-6 text-center">
                  ...
                  <p className="!text-[#8f857b] text-xs mt-2 max-w-md mx-auto">
                    {search
                      ...
                      : "Only papers with an approved status that have not yet been published appear here."}
                  </p>
              ...
              {!selectedPaper ? (
                <div className="px-5 py-10 text-center">
                  ...
                  <p className="!text-[#8f857b] text-[11px] leading-5 mt-2">
                    Select an approved paper from the list to enter its publication details.
                  </p>
                ...
                <div className="p-5">
                  ...
                  <div className="rounded-xl border border-[#e4ddd5] bg-[#fcfaf8] p-4">
                    ...
                    <h4 className="!text-[#302a25] text-sm font-semibold leading-5 mt-2">
                      {getSubmissionTitle(
                        selectedPaper
                      )}
                    </h4>

                    <p className="font-mono !text-[#91877d] text-[9px] mt-2 break-all">
                      {selectedPaper.id}
                    </p>
                  ...
                  <p className="!text-[#9a9188] text-[9px] leading-4 mt-3 text-center">
                    Publishing will add the paper to the selected year and volume.
                  </p>
