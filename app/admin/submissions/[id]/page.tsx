  ...
  return (
    <main className="min-h-screen bg-[#f5f6f7] text-[#16191c]">
      ...
      >
        ...
        <div className="h-[74px] border-b border-white/10 px-4 flex items-center justify-between">
        ...
        <nav className="px-3 py-5 overflow-y-auto h-[calc(100%-130px)]">
            ...
            (item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.section &&
                    !sidebarCollapsed && (
                    <p className="px-2.5 mt-5 mb-2 text-[8px] uppercase tracking-[0.2em] text-white/25 font-semibold">
                      {
                        item.section
                      }
                    </p>
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${
                        activeMenu ===
                        item.label
                          ? "bg-[#c7a77d] text-[#202b35] font-semibold"
        ...
        <header className="hidden lg:flex h-[74px] bg-white border-b border-[#e3e5e7] sticky top-0 z-30 px-7 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="text-[20px] font-semibold text-[#171a1d]">
                Manuscript Review
              </h1>
            ...
            <div className="relative p-6 md:p-8 lg:p-9">
              ...
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-7">
                ...
                <div className="min-w-0 max-w-4xl">
                  ...
                  <h2 className="text-2xl md:text-3xl lg:text-[34px] leading-[1.18] font-semibold tracking-[-0.025em] text-white">
                    {title}
                  </h2>
      ...
      {showReviewerModal && (
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-2xl max-h-[90vh] overflow-hidden rounded-2xl bg-white shadow-2xl border border-[#e4e6e8]">
            ...
            <div className="px-5 md:px-6 py-4 bg-[#fafbfb] border-t border-[#e5e7e9] flex flex-col sm:flex-row items-center justify-between gap-3">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                ...
                <button
                  ...
                  className="h-9 px-4 rounded-lg border border-[#dfe2e4] bg-white text-[#666] text-xs font-semibold hover:bg-[#f4f5f6] flex-1 sm:flex-none"
                >
                  Cancel
                </button>
                ...
                <button
                  ...
                  className="h-9 px-4 rounded-lg bg-[#202b35] text-white text-xs font-semibold hover:bg-[#16212a] disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-2 flex-1 sm:flex-none"
                >
