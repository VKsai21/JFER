...
export default function EditorialBoardPage() {
  ...
  const handleCvChange = (
    ...
    if (
      ...
      setMessage(
        "CV size must be less than 5 MB."
      );
                ...
                >
                  ...
                  {/* <div>
                    ...
                    <input
                      ...
                      className="w-full border border-black/[0.10] bg-white px-3 py-3 text-sm outline-none transition focus:border-[#a48768] file:mr-4 file:border-0 file:bg-[#f8f6f2] file:px-4 file:py-2 file:text-xs file:font-medium file:text-[#8f7054]"
                    />
                    ...
                    {cvFile && (
                      ...
                      <div className="mt-3 flex items-center gap-3 border border-[#a48768]/15 bg-[#a48768]/[0.06] px-4 py-3 text-sm text-[#8f7054]">
                  ...
                  {/* <div className="border border-black/[0.06] bg-[#f8f6f2] px-4 py-3">

                    <p className="text-xs leading-6 text-slate-500">
                      Your CV is collected with this application.
                      CV file storage will be enabled separately
                      by the journal administration.
                    </p>
